...
const paymentsEnabled = Boolean(process.env.NEXT_PUBLIC_STRIPE_PREMIUM_PRICE_ID)
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-primary-600 to-accent-600 rounded-xl shadow-lg p-8 text-white relative">
              ...
              {paymentsEnabled ? (
                ...
                <div className="w-full bg-primary-500/20 text-white/90 py-3 px-4 rounded-lg text-center">
